                            ...
                            <div className="flex h-[90vh] flex-col">
                                ...
                                <div className="my-auto">
                                    <div className="text-center">
                                        <h5 className="font-medium text-gray-700 dark:text-gray-100">Register
                                            Account</h5>
                                        <p className="mt-1 text-gray-500 dark:text-zinc-100/60">Get your free Minia  account now.</p>
                                    </div>

                                    <form className="pt-2 mt-4" action="">
                                        <div className="mb-4">
                                            <label className="block mb-2 font-medium text-gray-700 dark:text-gray-100">Email</label>
                                            <input type="text"
                                                   className="input w-full py-1.5 border-gray-100 rounded placeholder:text-13 bg-gray-50/30 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-gray-100 dark:placeholder:text-zinc-100/60 focus:ring focus:ring-violet-500/20 focus:border-violet-100 text-13"
                                                   id="email" placeholder="Enter Email"/>
                                        </div>
                                        <div className="mb-4">
                                            <label className="block mb-2 font-medium text-gray-700 dark:text-gray-100">Username</label>
                                            <input type="text"
                                                   className="input w-full py-1.5 border-gray-100 rounded placeholder:text-13 bg-gray-50/30 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-gray-100 dark:placeholder:text-zinc-100/60 focus:ring focus:ring-violet-500/20 focus:border-violet-100 text-13"
                                        ...
                                        <div className="mb-4">
                                            <div>
                                                <div className="flex-grow-1">
                                                    <label className="block mb-2 font-medium text-gray-700 dark:text-gray-100">Password</label>
                                                </div>
                                            </div>
                                        ...
                                        <div className="mb-6 row">
                                            <div className="col">
                                                <div>
                                                    <p className="text-gray-700 dark:text-zinc-100/60">By registering you agree to the Minia <a href="#" className="text-violet-500">Terms of Use</a></p>
                                                </div>
                                            </div>
                                        ...
                                        <div className="mb-4">
                                            <button
                                                className="btn border-transparent bg-violet-500 w-full py-2.5 text-white w-100 waves-effect waves-light shadow-md shadow-violet-200 dark:shadow-zinc-600"
                                    ...
                                    <div className="pt-2 mt-4 text-center">
                                        <div>
                                            <h6 className="mb-3 font-medium text-gray-500 text-14 dark:text-zinc-100/60">- Sign in with -</h6>
                                        </div>
                                    ...
                                    <div className="mt-12 text-center">
                                        <p className="text-gray-500 dark:text-zinc-100/60">Already have an account ? <a
                                            href="" className="font-semibold text-violet-500"> Login </a></p>
                                    </div>
                                </div>
                                ...
                                <div className="text-center ">
                                    <p className="relative text-gray-500 dark:text-gray-100">©
                                        <script></script>2025 Minia . Crafted
